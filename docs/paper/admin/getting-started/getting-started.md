...
To configure your server, see the [Global Configuration](../reference/global-configuration.md)
and [Per World Configuration](../reference/world-configuration.md) pages.
